import { animate, createScope, createTimeline, cubicBezier, onScroll, set, stagger, steps, svg, waapi } from 'animejs'
...
const anime = { animate, createScope, createTimeline, cubicBezier, onScroll, stagger, steps, svg, waapi, utils: { set }, readMotion } as const
